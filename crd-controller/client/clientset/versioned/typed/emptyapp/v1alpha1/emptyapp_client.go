...
import (
	...
	"k8s-client-demo/crd-controller/client/clientset/versioned/scheme"
	"net/http"
...
// CrdV1alpha1Client is used to interact with features provided by the crd.newegg.org group.
type CrdV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CrdV1alpha1Client) EmptyApps(namespace string) EmptyAppInterface {
	return newEmptyApps(c, namespace)
}
